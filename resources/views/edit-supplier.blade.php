        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <x-card>
                        <form class="forms-sample" action="{{ route('update-supplier') }}" method="post">
                            @csrf
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="cities" type="text" class="form-control" id="exampleInputCity1"
                                            placeholder="City" value="{{ $supplier->cities }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="bank" type="text" class="form-control" id="exampleInputBank1"
                                            placeholder="Bank" value="{{ $supplier->bank }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    <input hidden type="number" name="id" value="{{ $supplier->id }}">
