        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <div class="d-flex align-items-end flex-wrap">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <p class="text-primary mb-0 hover-cursor">Edit Vehicle</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <x-card>
                        <form class="forms-sample" action="{{ route('update-vehicle') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="nopol" type="string" class="form-control" id="exampleInputName1"
                                            placeholder="No Polisi" value="{{ $vehicle->nopol }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect2" name="cust_id"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option value="{{ $customer->id }}"
                                                    {{ $vehicle->cust_id == $customer->id ? 'selected' : '' }}>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="merk" type="text" class="form-control" id="exampleInputMerk1"
                                            placeholder="Merk" value="{{ $vehicle->merk }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="model" type="text" class="form-control"
                                            id="exampleInputModel1" placeholder="Model" value="{{ $vehicle->model }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="year" type="number" class="form-control" id="exampleInputYear1"
                                            placeholder="Year" value="{{ $vehicle->year }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    <input hidden type="number" name="id" value="{{ $vehicle->id }}">
