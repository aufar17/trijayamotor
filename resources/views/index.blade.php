                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <h2>Welcome back,</h2>
                                        <h4 class="text-primary mb-md-0">{{ $users->role }}</h4>
                                    </div>
                                    <div class="d-flex">
                                    ...
                                    <ul class="nav nav-tabs px-4" role="tablist">
                                        ...
                                        {{-- <li class="nav-item">
                                            <a class="nav-link" id="sales-tab" data-toggle="tab" href="#sales"
                                                ...
                                                aria-selected="false">Spareparts</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="purchases-tab" data-toggle="tab" href="#purchases"
                                                role="tab" aria-controls="purchases"
                                            ...
                                            <div class="d-flex flex-wrap justify-content-xl-between">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column align-items-center">
                                                        <i class="mdi mdi-calendar-heart icon-lg text-primary mb-2"></i>
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-around ml-3">
                                                        <small class="mb-1 text-muted">Transactions</small>
                                                        <h5 class="mr-2 mb-0">{{ $totalTransactions }}</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column justify-content-around">
                                                        ...
                                                        <h5 class="mr-2 mb-0">{{ $totalIncome }}</h5>
                                                    </div>
                                                </div>
                                                <div
                                                    class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                                                    <i
                                                        class="fa-solid fa-screwdriver-wrench icon-md mr-3 text-warning"></i>
                                                    <div class="d-flex flex-column justify-content-around">
                                                        <small class="mb-1 text-muted">Spareparts</small>
                                                        <h5 class="mr-2 mb-0">{{ $totalSpareparts }}</h5>
                                                    </div>
                                                </div>
                                                <div
                                                    class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                                                    <i class="fa-solid fa-box mr-3 text-info icon-md"></i>
                                                    <div class="d-flex flex-column justify-content-around">
                                                        <small class="mb-1 text-muted">Suppliers</small>
                                                        <h5 class="mr-2 mb-0">{{ $totalSuppliers }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
