                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form id="deleteForm"
                                                                action="{{ route('delete-inventory') }}" method="POST">
                                                                @csrf
                                                                <input hidden type="text" name="id"
                                                                    id="productId" value="{{ $inventory->id }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success"
                                                        href="{{ route('add-detail', ['id' => $inventory->id]) }}"><i
                                                            class="fa-solid fa-arrows-rotate"></i></a>
                                                    <a class="btn btn-info"
                                                        href="{{ route('detail-inventory', ['id' => $inventory->id]) }}"><i
                                                            class="fa-solid fa-circle-info"></i></a>
                                                    <a class="btn btn-warning"
                                                        href="{{ route('edit-inventory', ['id' => $inventory->id]) }}"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <button class="btn btn-danger" data-toggle="modal"
                                                        data-target="#deleteModal" data-id="{{ $inventory->id }}"><i
