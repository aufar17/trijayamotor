                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form id="deleteForm" action="{{ route('delete-supplier') }}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info"
                                                    href="{{ route('detail-supplier',['id' => $supplier->id]) }}"><i
                                                        class="fa-solid fa-circle-info"></i></a>
                                                <a class="btn btn-warning"
                                                    href="{{ route('edit-supplier', ['id' => $supplier->id]) }}"><i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <button class="btn btn-danger" data-toggle="modal"
                                                    data-target="#deleteModal" data-id="{{ $supplier->id }}"><i
                                                        class="fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="7" class="text-center fw-bold py-3 fs-6">There are no suppliers
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
